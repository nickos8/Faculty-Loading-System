...
<div class="max-w-5xl mx-auto px-4 py-6 space-y-6">
    ...
    <div class="rounded-2xl border border-white/40 bg-white/70 backdrop-blur shadow-sm">
        <div class="p-6 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
            <div class="space-y-1">
                <h1 class="text-2xl sm:text-3xl font-semibold tracking-tight text-slate-900">Edit Subject</h1>
                <p class="text-sm text-slate-600">Update subject details and manage its prerequisites.</p>
            </div>

            <div class="flex items-center gap-2">
                @if(\Illuminate\Support\Facades\Route::has('subjects.index'))
...
<div class="rounded-2xl border border-blue-100 bg-blue-50/50 p-4 shadow-sm">
    <div class="flex gap-3">
        ...
        <div class="flex-1">
            <div class="text-sm font-medium text-blue-900">Editing This Subject</div>
            <div class="text-xs text-blue-700 mt-1 space-y-1">
                <p>You are updating an existing subject in your program.</p>
                <p>The <strong>Subject Code</strong> must remain unique.</p>
                <p>Modifying <strong>prerequisites</strong> may affect student enrollment order.</p>
                <p>This subject cannot be assigned as its own prerequisite.</p>
            </div>
        </div>
    </div>
</div>
